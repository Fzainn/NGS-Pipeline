...
#
# Title abbreviations:
# 	 0 .. evol1 .. vars/evol1.freebayes.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='evol1')
    has_data = 1
...
if plot_indel_vaf and len(dat)>0:
    ...
    ax1 = fig.add_subplot(111)
    ax1.plot([-5,5], [0.5,0.5],color='#c5c5c5')
...
[0.380952380952381,0],
[0.428571428571429,0],
[0.476190476190476,13],
[0.523809523809524,16],
[0.571428571428571,10],
[0.619047619047619,5],
[0.666666666666667,5],
[0.714285714285714,3],
[0.761904761904762,0],
[0.80952380952381,1],
[0.857142857142857,3],
[0.904761904761905,14],
[0.952380952380952,84],
]
if plot_vaf_snv:
    fig = plt.figure(figsize=(4.33070866141732,3.93700787401575))
    ax1 = fig.add_subplot(111)
