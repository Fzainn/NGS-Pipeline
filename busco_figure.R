...
# Output
my_output <- paste("Busco-summaries/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('new_annotations', 'new_annotations', 'new_annotations', 'new_annotations')
...
my_percentage <- c(99.2, 0.0, 0.8, -0.0)
my_values <- c(123, 0, 1, 0)
